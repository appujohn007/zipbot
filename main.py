    ...
    try:
        ...
        with db_session:
            ...
            if usr.status == 1:  # check if user-status is "INSERT"
                ...
                await msg.reply("Sorry, you haven't initiated the zipping process. Please use the /zip command to start the zipping process.")
    except Exception as e:
        await msg.reply(f"An error occurred. Please try again later.\n\n {e}")
...
"""
        ...
        await msg.reply(f"Error in zipping: {e}........Please try again later.")
